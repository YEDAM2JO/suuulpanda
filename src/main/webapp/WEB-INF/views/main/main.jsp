...
<body>
	...
	<div align="center">
		...
		<script type="text/javascript"
			src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fc7464d2a4e6a63b76c439cbe264d159"></script>
		<script>
			var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
			mapOption = {
				center : new kakao.maps.LatLng(35.86906775230762,
						128.59328274668462), // 지도의 중심좌표
				level : 3
			// 지도의 확대 레벨
			};
			...
			// 마커가 표시될 위치입니다 
			var markerPosition = new kakao.maps.LatLng(35.86906775230762,
					128.59328274668462);
			...
			var iwContent = '<div style="padding:5px;">술판다 동성로점<br><a href="https://map.kakao.com/link/map/술판다 동성로점,35.86906775230762,128.59328274668462" style="color:blue" target="_blank">지도보기</a> <a href="https://map.kakao.com/link/to/술판다 동성로점,35.86906775230762,128.59328274668462" style="color:blue" target="_blank">길찾기</a></div>', iwPosition = new kakao.maps.LatLng(
					35.86906775230762, 128.59328274668462); //인포윈도우 표시 위치입니다
