  ...
  <table border="1">
    <tr>
      <td rowspan="12" style="width: 400px;">
        <img src="${pageContext.request.contextPath}/upload/${product.productImg}" alt="productImg" width="100" height="100">
        <br>
        <input type="file" id="file_${product.productImg}" name="pfile" onchange="showImage(this);" accept="image/*">
        <br>
        <img id="preview" src="${pageContext.request.contextPath}/upload/${product.productImg}" alt="미리보기 이미지" width="100" height="100">
    
        <input type="hidden" name="productImg" value="${img_filename}">
      </td>
    </tr>
  </table>
</form>        
            ...
            <form id="frm" action="productUpdate.do" method="post" enctype="multipart/form-data">
                <table border="1">
                    <tr>
                       ...
                       <td input type="file" rowspan="12" style="width: 400px;">
    <img src="${pageContext.request.contextPath}/upload/${product.productImg}" alt="productImg" width="100"
        height="100">
    <br>
    <input type="file" id="file_${product.productImg}" name="pfile" onchange="showImage(this);" accept="image/*">
    <br>
    <img id="preview" src="" alt="미리보기 이미지" width="100" height="100">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="product.productId" name="productId"
                                value="${product.productId != null ? product.productId : ''}">
                        <td>
                    </tr>
                    <tr>
                        <td>2</td>
                    ...
                    <tr>
                        ...
                        <td>특가가격</td>
                        <td>
                            <input type="text" id="product.productSalePrice" name="productSalePrice"
