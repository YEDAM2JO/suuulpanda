	   ...
	   <thead>
		...
		<tr>
	      <td colspan="2" align="center">
	        <input class="btn" style="background-color: #5c5c5c; color: #fff;" type="submit" value="회원탈퇴" onClick="inputCheck()"/>&nbsp;&nbsp;
	        <a href="userpage.do"><input class="btn" style="background-color: #5c5c5c; color: #fff;" type="button" value="취소"></a>
	      </td>
